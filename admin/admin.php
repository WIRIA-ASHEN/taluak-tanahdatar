...
if (isset($_POST['proses'])) {
    ...
    $query = $koneksi->query("INSERT INTO admin (id_admin, nama, sandi) VALUES ('$id_admin','$nama', '$sandi')");
...
<body>
    ...
    <div class="page-container">
        ...
        <li data-page-no="1">
            <div class="mx-auto page-width-2" style="margin-bottom: 200px;">
                <div class="row">
                    <div class="col-md-12 tm-contact-left">
                        <form action="" method="POST" class="contact-form"
                            ...
                            <div class="input-group justify-content-end">
                                <button class="btn btn-primary " type="submit" name="proses">SEND</button>
                            </div>
                        </form>
                    </div>
